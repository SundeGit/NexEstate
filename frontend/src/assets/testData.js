...
export const featuredProperties = [
  { _id: '1', image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=600', price: 150000, location: 'Novi Sad', type: 'Stan', area: 65 },
  ...
  { _id: '3', image: 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=600', price: 95000, location: 'Niš', type: 'Stan', area: 45 },
  { _id: '4', image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600', price: 45000, location: 'Subotica', type: 'Plac', area: 500 },
];
...
export const properties = [
  { _id: '1', image: 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=1200', price: 150000, location: 'Bulevar Oslobođenja 12, Novi Sad', type: 'Stan', area: 65, rooms: 2, floor: 3, furnished: true, parking: true, lift: true, heating: ['Centralno', 'Klima'], description: 'Odličan stan u centru Novog Sada. Stan se nalazi na trećem spratu zgrade sa liftom. Potpuno je namešten i opremljen. U blizini se nalaze sve potrebne institucije, prodavnice i javni prevoz.', coordinates: [45.2671, 19.8335], owner: { fullName: 'Luka Stefanović', phone: '+381611234567' } },
  { _id: '2', image: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=1200', price: 280000, location: 'Knez Mihailova 5, Beograd', type: 'Kuća', area: 180, rooms: 5, floor: 0, furnished: false, parking: true, elevator: false, heating: ['Gas', 'Podno grejanje'], description: 'Lepa kuća u centru Beograda sa velikim dvorištem.', coordinates: [44.8176, 20.4569], owner: { fullName: 'Jovana Nikolić', phone: '+381611234567' } },
  { _id: '3', image: 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=1200', price: 95000, location: 'Obrenovićeva 3, Niš', type: 'Stan', area: 45, rooms: 1, floor: 2, furnished: true, parking: false, elevator: true, heating: ['Centralno'], description: 'Manji stan u Nišu, idealan za studente.', coordinates: [43.3209, 21.8954], owner: { fullName: 'Stefan Jovanović', phone: '+381621234567' } },
  { _id: '4', image: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1200', price: 45000, location: 'Cara Lazara 10, Subotica', type: 'Plac', area: 500, rooms: 0, floor: 0, furnished: false, parking: false, elevator: false, heating: [], description: 'Plac u Subotici, pogodan za gradnju.', coordinates: [46.1000, 19.6658], owner: { fullName: 'Ana Đorđević', phone: '+381631234567' } },
  { _id: '5', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200', price: 320000, location: 'Vojvode Stepe 22, Beograd', type: 'Kuća', area: 220, rooms: 6, floor: 0, furnished: true, parking: true, elevator: false, heating: ['Gas', 'Klima'], description: 'Prostrana kuća sa velikim dvorištem i garažom.', coordinates: [44.7866, 20.4489], owner: { fullName: 'Milan Stojanović', phone: '+381641234567' } },
  { _id: '6', image: 'https://images.unsplash.com/photo-1605276374104-dee2a0ed3cd6?w=1200', price: 75000, location: 'Futoška 8, Novi Sad', type: 'Stan', area: 38, rooms: 1, floor: 1, furnished: false, parking: false, elevator: false, heating: ['Centralno'], description: 'Manji stan u Novom Sadu, blizu centra.', coordinates: [45.2550, 19.8450], owner: { fullName: 'Petra Vasić', phone: '+381651234567' } },
];